package com.spb.skilltracker.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.spb.skilltracker.service..*(..))")
    public void anyServiceMethod() {}

    @Pointcut("execution(* com.spb.skilltracker.service.log.ErrorLogCleanupService.cleanupOldLogs(..))")
